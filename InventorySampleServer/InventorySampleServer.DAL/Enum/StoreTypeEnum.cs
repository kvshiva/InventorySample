...
{
	public class StoreTypeEnumDAL<TEntity> : BaseDAL<TEntity> where TEntity : class
	{
		public StoreTypeEnumDAL(SqlConnection? Connection, SqlTransaction? Transaction) : base(Connection, Transaction) { }
		...
		public override async Task<int> Add(TEntity Entity)
		{
			...
			try
			{
				var Command = @"INSERT INTO [Store].[StoreTypeEnum]
												(
													[Version],
													[CreatedBy],
													[CreatedDateTime],
		...
		public override async Task<int> Edit(TEntity Entity)
		{
			...
			try
			{
				var Command = @"UPDATE [Store].[StoreTypeEnum] SET
									[Version] = @Version,
									[UpdatedBy] = @UpdatedBy,
		...
		public override async Task<int> Delete(int Id)
		{
			...
			try
			{
				var Command = @"Delete [Store].[StoreTypeEnum] WHERE [Id] = @Id ";
