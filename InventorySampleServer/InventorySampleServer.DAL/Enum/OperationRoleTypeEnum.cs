...
{
	public class OperationRoleTypeEnumDAL<TEntity> : BaseDAL<TEntity> where TEntity : class
	{
		public OperationRoleTypeEnumDAL(SqlConnection? Connection, SqlTransaction? Transaction) : base(Connection, Transaction) { }
		...
		public override async Task<int> Add(TEntity Entity)
		{
			...
			try
			{
				var Command = @"INSERT INTO [General].[OperationRoleTypeEnum]
												(
													[Version],
													[CreatedBy],
													[CreatedDateTime],
		...
		public override async Task<int> Edit(TEntity Entity)
		{
			...
			try
			{
				var Command = @"UPDATE [General].[OperationRoleTypeEnum] SET
									[Version] = @Version,
									[UpdatedBy] = @UpdatedBy,
		...
		public override async Task<int> Delete(int Id)
		{
			...
			try
			{
				var Command = @"Delete [General].[OperationRoleTypeEnum] WHERE [Id] = @Id ";
