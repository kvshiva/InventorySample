...
{
	public class StateMachineTypeEnumDAL<TEntity> : BaseDAL<TEntity> where TEntity : class
	{
		public StateMachineTypeEnumDAL(SqlConnection? Connection, SqlTransaction? Transaction) : base(Connection, Transaction) { }
		...
		public override async Task<int> Add(TEntity Entity)
		{
			...
			try
			{
				var Command = @"INSERT INTO [State].[StateMachineTypeEnum]
												(
													[Version],
													[CreatedBy],
													[CreatedDateTime],
		...
		public override async Task<int> Edit(TEntity Entity)
		{
			...
			try
			{
				var Command = @"UPDATE [State].[StateMachineTypeEnum] SET
									[Version] = @Version,
									[UpdatedBy] = @UpdatedBy,
		...
		public override async Task<int> Delete(int Id)
		{
			...
			try
			{
				var Command = @"Delete [State].[StateMachineTypeEnum] WHERE [Id] = @Id ";
