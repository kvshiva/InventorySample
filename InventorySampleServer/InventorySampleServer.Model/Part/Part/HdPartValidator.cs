...
{
	public class HdPartValidator : AbstractValidator<HdPartDto>
	{
		public HdPartValidator()
		{
			...
			RuleFor(e => e.PartStoreList).NotNull().Must(e => e?.Count > 0).WithMessage(ValidationMessage.NotEmptyListErrorMessage("انبارهای دارای گردش کالا"));
			RuleForEach(e => e.PartStoreList).SetValidator(new Model.Part.PartStore.HdPartStoreListValidator());
		}
	}
}
